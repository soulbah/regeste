...
export const fr: Record<keyof typeof en, string> = {
	...
	'modes.best': 'Recommandé',
	'modes.bestReason.noGpu': "ce navigateur ne peut pas exécuter l'IA sur votre appareil",
	'modes.bestReason.local': 'cet appareil peut faire tourner le modèle lui-même',
	...
	'modes.private.preparing': 'Préparation du modèle local… {pct}%',
	...
	'modes.activated': '{mode} est prêt, et c’est le mode actif.',
	...
	'app.workerFailed.privateAi': 'Le modèle local ne fonctionne plus.',
	...
	'settings.models.benchDesc': 'Un court test mesure la vitesse du modèle local sur cet appareil.',
	'settings.models.testing': 'Test…',
	'settings.models.test': 'Tester mon appareil',
	'settings.models.prepareFirst':
		'Téléchargez d’abord le modèle local, depuis le sélecteur de mode.',
	...
	'landing.modes.show': 'Voir ce mode',
	'landing.modes.showing': 'À l’écran',
	'landing.modes.private.cost': 'Un téléchargement au départ, des réponses plus lentes.',
	'landing.modes.assisted': 'Connectez-vous, et la réponse est rédigée en ligne.',
	'landing.modes.assisted.cost': 'Un compte, et un quota par jour.',
	'landing.modes.myai': 'Pour une IA que vous hébergez déjà, comme Ollama ou LM Studio.',
	'landing.modes.myai.cost': 'Un serveur que vous gardez allumé.',
	'landing.cite.title': 'Chaque affirmation montre sa source.',
	'landing.cite.sub':
		'Chaque réponse renvoie à des passages numérotés. Un clic ouvre le document sur le passage exact, surligné.',
	'landing.oss.title': 'Open source, de bout en bout',
	'landing.oss.sub':
		'Le code est public, sous licence AGPL. Hébergez-le sur votre propre domaine, ou aidez à le faire évoluer.',
	'landing.oss.cta': 'Contribuer sur GitHub',
	'landing.cite.f1': 'Les sources apparaissent au-dessus de la réponse.',
	'landing.cite.f2': 'Supprimez un document : les passages déjà cités restent lisibles.',
	'landing.cite.fig': 'Fig. 02 · Une réponse, ses sources, et le bail ouvert sur la clause.',
	'landing.deck.title': 'Rien ne part sans votre accord.',
	'landing.deck.sub':
		'Les passages retenus pour votre question s’affichent avant l’envoi, et vous décochez ceux qui doivent rester ici. La réponse garde ensuite la même liste, en indiquant pour chaque passage s’il est parti ou non.',
	'landing.deck.before': 'Avant l’envoi',
	'landing.deck.after': 'Ce qui est conservé',
	'landing.deck.intact': 'Rien n’est parti',
	'landing.deck.found': 'Trouvés dans vos documents',
	'landing.deck.keep': 'Vous en écartez',
	'landing.deck.ready': 'Prêts à partir',
	'landing.deck.gone': 'Partis de cet appareil',
	'landing.deck.stayed': 'Restés ici',
	'landing.deck.keptWith': 'Conservé avec la réponse',
	'landing.deck.keptWithValue': 'Le temps de la discussion',
	'landing.deck.kbUnit': 'Ko',
	'landing.deck.bring': 'Mettre {name} au premier plan',
	'landing.deck.f1': 'Votre accord est demandé une seule fois, avant le premier envoi.',
	'landing.deck.f2': 'Le Rapport de confidentialité en tient le compte.',
	...
	'hiw.intro':
		'Vos documents sont lus, indexés et fouillés dans ce navigateur. Les modes ne changent qu’une chose : qui rédige la réponse, et donc ce qui doit sortir.',
	'hiw.whatStays': 'Ce qui reste',
	'hiw.server': 'Le serveur',
	'hiw.private.leaves':
		'Rien. Le modèle local tourne dans votre navigateur, téléchargé une seule fois.',
	'hiw.private.stays':
		'Documents, index, discussions, le modèle local, vos questions et vos réponses.',
	'hiw.private.server': 'Jamais contacté pour répondre. Aucun compte requis.',
	'hiw.assisted.leaves':
		'Votre question et les passages que vous avez validés à la relecture. Jamais un document entier, jamais un nom de fichier.',
	...
	'hiw.myai.leaves':
		'Votre question et les passages retenus, envoyés directement au serveur que vous avez configuré.',
	...
	'hiw.lane.answer': 'Rédiger la réponse',
	...
	'hiw.footer':
		'Le code est open source. Inspectez-le, hébergez-le vous-même, ou coupez le réseau et gardez tout sur cet appareil.',
